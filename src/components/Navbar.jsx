  ...
  return (
    <div className="bg-white py-3 shadow-2xl">
      <div className="max-w-6xl mx-auto px-4 flex justify-between items-center">
        ...
        {/* LEFT */}
        <div className="flex gap-3 md:gap-7 items-center relative">

          <Link to={"/"}>
            <h1 className="font-bold text-xl md:text-3xl text-pink-600">
          ...
          <div className="flex gap-1 cursor-pointer text-gray-700 items-center text-sm md:text-base">
          ...
          {openDropdown && (
            <div className="w-[250px] shadow-2xl z-50 bg-white absolute top-14 left-0 md:left-60 border p-5 rounded-md">
              <h1 className="font-semibold mb-4 text-base md:text-xl flex justify-between">
                Want to Update location
        ...
        <nav className="hidden md:flex gap-7 items-center">
          ...
          <Link to="/cart" className="relative">
            ...
            <span className="bg-red-500 px-2 rounded-full absolute -top-3 -right-3 text-white text-xs">0</span>
          </Link>
